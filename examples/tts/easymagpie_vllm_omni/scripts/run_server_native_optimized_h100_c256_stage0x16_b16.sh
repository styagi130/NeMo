#!/usr/bin/env bash
# Launch the C256 sixteen-B16-replica memory-feasibility experiment.
set -euo pipefail
...
export EASYMAGPIE_DEPLOY_CONFIG="${SCRIPT_DIR}/../deploy/easymagpie_native_optimized_h100_c256_stage0x16_b16.yaml"
