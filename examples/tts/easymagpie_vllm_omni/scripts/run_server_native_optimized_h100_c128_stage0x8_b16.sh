#!/usr/bin/env bash
# Launch C128 as eight independent B16 Stage-0 cohorts.
set -euo pipefail
...
export EASYMAGPIE_DEPLOY_CONFIG="${SCRIPT_DIR}/../deploy/easymagpie_native_optimized_h100_c128_stage0x8_b16.yaml"
